...
show_help()
{
	...
	echo "Options:"
	echo "-e, --env <env-path>				The path of environment variable file generated by env-processh.sh."
	echo "-L, --namelist <namelist-path>	Generate one package containing all the files referred inside namelist-path."
	echo "-p, --path <package-path>			The path of the package."
...
echo "/proc /proc">>$common_mountlist
echo "/sys /sys">>$common_mountlist
